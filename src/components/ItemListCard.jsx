    ...
    <li class="m-2 overflow-hidden rounded-lg border border-red-200 shadow-lg">
      ...
      <div class="p-6">
        ...
        <div className="space-y-2 space-x-3 pt-4">
          <span className="rounded-lg border-2 border-black bg-green-400 p-1 text-sm font-semibold">
            {item.target}
          </span>

          <span className="rounded-lg border-2 border-black bg-rose-400 p-1 text-sm font-semibold">
            {item.bodyPart}
          </span>

          <span className="rounded-lg border-2 border-black bg-orange-400 p-1 text-sm font-semibold">
            {item.equipment}
          </span>
        </div>
